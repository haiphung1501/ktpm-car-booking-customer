    ...
    <SafeAreaView className="flex-1 bg-green-100">
      <ScrollView className="flex-1 bg-green-100 pb-4">
        <View className="h-[200px] bg-transparent">
          ...
          />
          <TouchableOpacity className="absolute flex flex-row flex-nowrap top-4 right-4 items-center px-4 py-2 bg-green-200 rounded-full" onPress={() => navigation.navigate("Location")}>
